...
const SERVICE: Training[] = [
  {
    code: "სფ-1",
    title: "მომსახურების ოსტატობა",
    subtitle: "კომუნიკაცია, კლიენტთან ურთიერთობა და პროფესიული სტანდარტები",
    audience:
      "მომსახურების ცენტრების, ფილიალების და ქოლ-ცენტრის გუნდები; გუნდის ლიდერები და სუპერვაიზერები.",
    duration: "3 შეხვედრა × 2 საათი = 6 საათი · 3-დღიანი პროგრამა",
    price: "",
    summary:
      "მომსახურების სრული ციკლის პრაქტიკული ტრენინგი პროფესიული კომუნიკაციიდან და პირველი შთაბეჭდილებიდან რთული სიტუაციების მართვამდე, ემოციურ მდგრადობასა და გუნდურ თანამშრომლობამდე.",
    overview: [
      "მომსახურების სფეროში წარმატება დამოკიდებულია არა მხოლოდ პროდუქტსა თუ პროცესზე, არამედ იმ ადამიანურ გამოცდილებაზე, რომელსაც კლიენტი იღებს ყოველ საკონტაქტო წერტილში - ფილიალში, ცხელ ხაზზე თუ ონლაინ არხზე.",
      "ეს სამდღიანი, 3 × 2 საათიანი სოფთ სქილს ტრენინგი მონაწილეებს გადაატარებს მომსახურების სრულ ციკლს: პროფესიული კომუნიკაციისა და პირველი შთაბეჭდილებიდან რთულ სიტუაციებთან და საჩივრებთან მუშაობამდე და დაასრულებს ემოციური მდგრადობისა და გუნდური თანამშრომლობის განვითარებით.",
      "ტრენინგი აგებულია პრაქტიკული სავარჯიშოების, როლური თამაშებისა და რეალურ სამუშაო სცენარებზე დაფუძნებული მაგალითების გარშემო, რათა მონაწილემ მიღებული უნარები პირდაპირ გადაიტანოს ყოველდღიურ საქმიანობაში.",
    ],
    ctaLabel: "იხილე ტრენინგი",
    modules: [
      {
        title: "ვისთვისაა",
        items: [
          "მომსახურების ცენტრების, ფილიალების და ქოლ-ცენტრის თანამშრომლები",
          "კლიენტთან უშუალო კონტაქტში მყოფი გუნდები - გაყიდვები, მხარდაჭერა, საკონტაქტო ხაზი",
          "გუნდის ლიდერები და სუპერვაიზერები, რომლებსაც სურთ მომსახურების სტანდარტების გაძლიერება",
          "ორგანიზაციები, სადაც მაღალია კლიენტთა ნაკადი და საკონტაქტო წერტილების რაოდენობა",
        ],
      },
      {
        title: "ტრენინგის ფორმატი",
        items: [
          "ხანგრძლივობა: 3 შეხვედრა × 2 საათი = 6 საათი",
          "ჩატარების ადგილი: ონლაინ Google Meet / MS Teams / Zoom ან ფიზიკურად თბილისში",
          "რეგიონებში: წინასწარი შეთანხმებით",
          "ენა: ქართული",
          "ფორმატი: ინტერაქტიული ლექცია + როლური თამაშები + პრაქტიკული სავარჯიშოები + ჯგუფური განხილვა",
          "ჯგუფის ზომა: რეკომენდებული 8-15 მონაწილე, კორპორატიული ჯგუფისთვის მორგებადი",
          "ტრენინგის ავტორი: ნანა ლობჯანიძე, PMP®",
        ],
      },
      {
        title: "დღე 1 - მომსახურების კულტურა და ეფექტური კომუნიკაცია",
        items: [
          "მომსახურების კულტურა და მისი გავლენა ბიზნესზე",
          "ეფექტური კომუნიკაციის საფუძვლები",
          "პირველი შთაბეჭდილება და საკონტაქტო წერტილები",
          "პრაქტიკული სავარჯიშო: მისალმება და საჭიროების იდენტიფიცირება",
        ],
      },
      {
        title: "დღე 2 - რთულ სიტუაციებთან და კლიენტებთან მუშაობა",
        items: [
          "რთული კლიენტის ტიპოლოგია და ემოციური ტრიგერები",
          "საჩივრის დამუშავების მოდელი",
          "დეესკალაცია და კონფლიქტის მართვა",
          "პრაქტიკული სავარჯიშო: საჩივრის დამუშავების როლური სიმულაცია",
        ],
      },
      {
        title: "დღე 3 - ემოციური ინტელექტი, სტრესის მართვა და გუნდური თანამშრომლობა",
        items: [
          "ემოციური ინტელექტი მომსახურების კონტექსტში",
          "სტრესის მართვა და გადაწვის პრევენცია",
          "გუნდური თანამშრომლობა და შიდა კომუნიკაცია",
          "პრაქტიკული სავარჯიშო და პირადი სამოქმედო გეგმა",
        ],
      },
      {
        title: "მონაწილე მიიღებს",
        items: [
          "ტრენერის მიერ მომზადებულ სტრუქტურირებულ სალექციო მასალებს",
          "პრაქტიკულ სცენარებს და როლური თამაშების სკრიპტებს",
          "თვითშეფასების ჩეკლისტებს",
          "პირადი სამოქმედო გეგმის შაბლონს",
          "ტრენინგის დასრულების სერტიფიკატს",
        ],
      },
      {
        title: "კორპორატიული ფორმატი",
        items: [
          "ტრენინგი ხელმისაწვდომია კორპორატიული ფორმატით და შეიძლება მოერგოს კომპანიის სფეროს, გუნდის სიდიდეს და რეალურ სამუშაო სცენარებს.",
        ],
      },
    ],
  },
  {
    code: "სფ-2",
    title: "მომსახურების კულტურა და ეფექტური კომუნიკაცია",
    audience:
      "მომსახურების ცენტრების, ქოლ-ცენტრისა და საკონტაქტო ხაზის თანამშრომლები; გუნდები, რომლებიც პირდაპირ კონტაქტში არიან კლიენტებთან.",
    duration: "2 საათი · დამოუკიდებელი ტრენინგი",
    price: "",
    summary:
      "მომსახურების კულტურის, აქტიური მოსმენის, პროფესიული კომუნიკაციისა და პირველი შთაბეჭდილების პრაქტიკული ტრენინგი.",
    ctaLabel: "იხილე ტრენინგი",
    modules: [
      {
        title: "ვისთვისაა",
        items: [
          "მომსახურების ცენტრების, ქოლ-ცენტრის და საკონტაქტო ხაზის თანამშრომლები",
          "ახალდაწყებული თანამშრომლები, რომლებსაც სჭირდებათ მომსახურების სტანდარტების გაცნობა",
          "გუნდები, რომლებიც პირდაპირ კონტაქტში არიან კლიენტებთან ფილიალში, ტელეფონით ან ონლაინ არხებზე",
        ],
      },
      {
        title: "რას მიიღებს მონაწილე",
        items: [
          "გაიაზრებს, რა განსხვავებაა უბრალო მომსახურებასა და კლიენტზე ორიენტირებულ გამოცდილებას შორის",
          "დაეუფლება აქტიური მოსმენის და პროფესიული ტონის ტექნიკებს",
          "შეძლებს პირველი შთაბეჭდილების მართვას საკონტაქტო წერტილის სხვადასხვა ფორმატში",
          "გამოიმუშავებს მკაფიო, თავაზიან და ორგანიზაციის სტანდარტების შესაბამის კომუნიკაციის სტილს",
        ],
      },
      {
        title: "სილაბუსი",
      ...
      },
      {
        ...
        items: [
          ...
          "ტიპი: დამოუკიდებელი ტრენინგი",
          "ენა: ქართული",
          "ფორმატი: ონლაინ ან ფიზიკურად",
          "ტრენინგის ავტორი: ნანა ლობჯანიძე, PMP®",
        ],
      },
    ],
  ...
  {
    code: "სფ-3",
    title: "რთულ სიტუაციებთან და კლიენტებთან მუშაობა",
    audience:
      "თანამშრომლები, რომლებიც რეგულარულად აწყდებიან პრეტენზიებსა და საჩივრებს; ქოლ-ცენტრის გუნდები; სუპერვაიზერები.",
    duration: "2 საათი · დამოუკიდებელი ტრენინგი",
    price: "",
    summary:
      "პრაქტიკული ტრენინგი რთული კლიენტების, საჩივრების, დეესკალაციისა და კონფლიქტური სიტუაციების პროფესიულად მართვაზე.",
    ctaLabel: "იხილე ტრენინგი",
    modules: [
      {
        title: "ვისთვისაა",
        items: [
          "თანამშრომლები, რომლებიც რეგულარულად აწყდებიან პრეტენზიებს, საჩივრებს ან დაძაბულ კლიენტებს",
          "ქოლ-ცენტრისა და მომსახურების ცენტრის გუნდები",
          "სუპერვაიზერები",
          "ადამიანები, რომლებსაც სურთ კონფლიქტის დეესკალაციისა და უარის პროფესიულად თქმის ტექნიკების განვითარება",
        ],
      },
      {
        title: "რას მიიღებს მონაწილე",
        items: [
          "შეძლებს რთული ან აღშფოთებული კლიენტის ემოციის ამოცნობასა და მართვას",
          "დაეუფლება საჩივრის დამუშავების სტრუქტურირებულ მოდელს",
          "ისწავლის უარის ან შეზღუდვის პროფესიულად კომუნიკაციას",
          "მიიღებს პრაქტიკულ ჩარჩოს დაგვიანების, დაკარგული ამანათის, რიგის ან სისტემურ პრობლემებზე რეაგირებისთვის",
        ],
      },
      {
        title: "სილაბუსი",
  ...
  {
    code: "სფ-4",
    title: "სტრესის მართვა, ემოციური ინტელექტი და გუნდური თანამშრომლობა",
    audience:
      "მაღალი დატვირთვის მქონე მომსახურების გუნდები; გუნდის ლიდერები, ვისაც შიდა კომუნიკაციის გაუმჯობესება სურს.",
    duration: "2 საათი · დამოუკიდებელი ტრენინგი",
    price: "",
    summary:
      "პრაქტიკული ტრენინგი ემოციური ინტელექტის, სტრესის მართვის, გადაწვის პრევენციისა და გუნდური თანამშრომლობის გასაძლიერებლად.",
    ctaLabel: "იხილე ტრენინგი",
    modules: [
      {
        title: "ვისთვისაა",
        items: [
          "მაღალი დატვირთვის მქონე მომსახურების გუნდები",
          "თანამშრომლები, რომლებსაც სურთ პროფესიული გადაწვის პრევენცია და ემოციური მდგრადობის გაძლიერება",
          "გუნდის ლიდერები, რომლებსაც სურთ შიდა კომუნიკაციისა და თანამშრომლობის გაუმჯობესება",
        ],
      },
      {
        title: "რას მიიღებს მონაწილე",
        items: [
          "გაეცნობა ემოციური ინტელექტის ძირითად კომპონენტებს და მათ გამოყენებას ყოველდღიურ სამუშაოში",
          "შეიძენს პრაქტიკულ ტექნიკებს სტრესისა და დაძაბულობის თვითმართვისთვის სამუშაო საათებში",
          "გაიაზრებს გადაწვის ნიშნებსა და პრევენციის მიდგომებს მაღალი დატვირთვის გარემოში",
          "შეიმუშავებს პირად სამოქმედო გეგმას გუნდურ თანამშრომლობასა და შიდაორგანიზაციულ კომუნიკაციაში გასაუმჯობესებლად",
        ],
      },
      {
        title: "სილაბუსი",
...
const CATEGORIES: Category[] = [
  ...
  },
  {
    num: "05",
    key: "service",
    tag: "სპეციალიზებული ტრენინგები",
    title: "სპეციალიზებული ტრენინგები მომსახურების სფეროსთვის",
    intro:
      "პრაქტიკული სოფთ სქილს ტრენინგები მომსახურების სფეროს გუნდებისთვის - პროფესიული კომუნიკაცია, რთულ სიტუაციებთან მუშაობა, ემოციური ინტელექტი, სტრესის მართვა და გუნდური თანამშრომლობა.",
    accent: "mint",
    items: SERVICE,
  },
];
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-6 rounded-2xl border p-5 md:p-6" style={{ borderColor: "var(--line)", background: "white" }}>
            ...
            <p className="mt-3 text-sm md:text-base text-ink-soft leading-relaxed">
              სასწავლო პროგრამა ეფუძნება საერთაშორისო პროფესიულ სტანდარტებს, თანამედროვე მეთოდოლოგიებსა და პრაქტიკულ მიდგომებს. სასწავლო პროცესში გამოყენებულია ტრენერის მიერ მომზადებული მასალები, პროფესიული რესურსები და რეალურ სამუშაო გარემოზე დაფუძნებული პრაქტიკული მაგალითები.
            </p>
            <p className="mt-3 text-sm md:text-base text-ink-soft leading-relaxed">
              მონაწილეები მიიღებენ:
            </p>
            <ul className="mt-2 space-y-2 text-sm md:text-base text-ink-soft leading-relaxed list-disc pl-5">
              <li>ტრენერის მიერ მომზადებულ სტრუქტურირებულ სალექციო და სასწავლო მასალებს;</li>
              <li>დამატებით პროფესიულ რესურსებს, სასარგებლო ბმულებსა და ელექტრონულ სასწავლო მასალებს;</li>
              <li>რეალურ პრაქტიკაზე დაფუძნებულ ქართულ და საერთაშორისო Case Study-ებს;</li>
              <li>ბიზნეს-სცენარებსა და პრაქტიკულ სიმულაციებს;</li>
              <li>ინდივიდუალურ და ჯგუფურ პრაქტიკულ სავარჯიშოებს;</li>
              <li>პრაქტიკულ დავალებებს, რომლებიც ხელს უწყობს მიღებული ცოდნის რეალურ სამუშაო გარემოში გამოყენებას.</li>
            </ul>
            <p className="mt-4 text-sm md:text-base text-ink-soft leading-relaxed">
              სასწავლო მასალები და რესურსები შერჩეულია პროგრამის მიზნებისა და მონაწილეთა პრაქტიკული საჭიროებების შესაბამისად, რათა სწავლის პროცესი იყოს პრაქტიკული, თანამედროვე და უშუალოდ სამუშაოზე ორიენტირებული.
            </p>
          </div>
        </div>
