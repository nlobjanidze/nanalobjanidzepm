...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ნანა ლობჯანიძე — PMP® სერტიფიცირებული პროექტების მართვის კონსულტანტი" },
      { name: "description", content: "PMP® სერტიფიცირებული პროექტების მართვის კონსულტანტი, ტრენერი და მენტორი. კონსულტაცია, PMP® მომზადება, Agile, საგრანტო პროექტების მართვა და PMO ჩამოყალიბება." },
      { name: "author", content: "ნანა ლობჯანიძე" },
      { name: "theme-color", content: "#ffffff" },
      { property: "og:title", content: "ნანა ლობჯანიძე — PMP® სერტიფიცირებული პროექტების მართვის კონსულტანტი" },
      { property: "og:description", content: "PMP® სერტიფიცირებული პროექტების მართვის კონსულტანტი, ტრენერი და მენტორი. კონსულტაცია, PMP® მომზადება, Agile, საგრანტო პროექტების მართვა და PMO ჩამოყალიბება." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ნანა ლობჯანიძე — PMP® სერტიფიცირებული პროექტების მართვის კონსულტანტი" },
      { name: "twitter:description", content: "PMP® სერტიფიცირებული პროექტების მართვის კონსულტანტი, ტრენერი და მენტორი. კონსულტაცია, PMP® მომზადება, Agile, საგრანტო პროექტების მართვა და PMO ჩამოყალიბება." },
